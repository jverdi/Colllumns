...
#define CLSTYLESHEET ((ColllumnsStyles *)[TTStyleSheet globalStyleSheet]) 
#define CLSTYLEVAR(_VARNAME) [CLSTYLESHEET _VARNAME] 

@interface ColllumnsStyles : TTDefaultStyleSheet {
